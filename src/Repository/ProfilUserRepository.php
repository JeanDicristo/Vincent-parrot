 ...
 *
 * @implements PasswordUpgraderInterface<ProfilUser>
 *
 ...
 */
class ProfilUserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
